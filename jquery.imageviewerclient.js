...
* Copyright (C) 2014 R. van der Ark, Koninklijke Bibliotheek - National Library of the Netherlands
*
			...
			var y = box.y * scale,
				...
				w = box.w * scale -
					(box.x * scale + box.w * scale > _self.width() ?
								box.x * scale + box.w * scale - _self.width() : 0) - 2,
				h = box.h * scale -
					(box.y * scale + box.h * scale > _self.height() ?
								box.y * scale + box.h * scale - _self.height() : 0) - 2,
